package patterns.creational.factory.abstr;
...
class HotDrinkMachine {
    ...
    public HotDrinkMachine() throws Exception {
        ...
        Set<Class<? extends HotDrinkFactory>> subTypes
                = new Reflections("patterns.creational.factory")
                .getSubTypesOf(HotDrinkFactory.class);

        for (Class<? extends HotDrinkFactory> type : subTypes)
        {
